...
/**
 * Footer Component
 * Minimal footer with legal links and social media
 */
            ...
            <Container>
                <div className="flex flex-col md:flex-row justify-between items-center gap-6">
                    ...
                    <div className="flex flex-wrap justify-center md:justify-start gap-x-6 gap-y-2 text-sm">
                        ...
                        <Link href="/about-our-ads" className="hover:text-white transition-colors">
                            About our ads
                        </Link>
                    </div>
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div className="flex gap-3">
                            ...
                            <a
                                ...
                                className="w-9 h-9 flex items-center justify-center rounded-full bg-neutral-800 hover:bg-primary-900 transition-colors"
                ...
                <div className="mt-6 pt-6 border-t border-neutral-800 text-center text-sm text-neutral-500">
                    © {currentYear} Bargainly. All rights reserved.
                </div>
            </Container>
        </footer>
    )
