        ...
        <div className="min-h-screen bg-neutral-100 py-8 px-4 sm:px-6 lg:px-8">
            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className="mb-8">
                    ...
                    <h1 className="text-3xl font-bold text-neutral-900">Create New Guide</h1>
                    <p className="mt-2 text-neutral-600">Create a comprehensive buying guide with product recommendations.</p>
                </div>
                    ...
                    <div className="bg-white rounded-lg border border-neutral-200 overflow-hidden">
                        ...
                        <div className="p-6 space-y-6">
                            ...
                            <div>
                                ...
                                />
                                <p className="mt-1 text-xs text-neutral-500">Auto-generated from title, but you can customize it</p>
                            </div>
