...
export default function EditCategoryPage() {
    ...
    const fetchCategory = async () => {
        try {
            ...
            setFormData({
                ...
                l2_categories: data.l2_categories || ''
            })
        } catch (error) {
    ...
    const fetchLevel1Categories = async () => {
        try {
            ...
            const data = await response.json()
            const level1 = (data || []).filter((c: Category) => c.level === 1 && c.id !== categoryId)
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const res = await fetch(`http://localhost:3001/api/v1/categories/${categoryId}`, {
                method: 'PATCH',
            ...
            // Navigate and force refresh to show updated category immediately
            ...
            <div className="min-h-screen bg-neutral-100 py-8 px-4 sm:px-6 lg:px-8">
                <div className="max-w-4xl mx-auto">
                    <div className="flex items-center justify-center h-64">
                        <div className="text-neutral-600">Loading category...</div>
                    </div>
                </div>
            </div>
        )
            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className="mb-8">
                    <div className="flex items-center gap-2 text-sm text-neutral-500 mb-3">
                        ...
                        <span>/</span>
                        <span className="text-neutral-900 font-medium">Edit Category</span>
                    </div>
                    <h1 className="text-3xl font-bold text-neutral-900">Edit Category</h1>
                    <p className="mt-2 text-neutral-600">Update category information.</p>
                </div>
