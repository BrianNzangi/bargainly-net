    ...
    const fetchProduct = async () => {
        try {
            ...
            setFormData({
                ...
                price_current: product.price_current?.toString() || '',
                ...
                total_ratings: product.total_ratings?.toString() || '',
        ...
        <div className="min-h-screen bg-neutral-100 py-8 px-4 sm:px-6 lg:px-8">
            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className="mb-8">
                    ...
                    <p className="mt-2 text-neutral-600">Update product information and details.</p>
                </div>
